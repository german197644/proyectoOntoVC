...
public class MetsDeposit {
    ...
    public MetsDeposit() throws Exception {
        this.setUp();
    }
    ...
    {     
        ...
        FileInputStream propertiesStream = new FileInputStream("src/main/java/propiedades/spectests.properties");
                    ...
                    throws Exception
    {
            ...
            ServiceDocument sd = client.getServiceDocument(this.sdIRI.trim(), new AuthCredentials(this.user.trim(), this.pass.trim()));
